...
async def get_explore(location_name: Annotated[int, Path(title="The ID of the item to get")]):
    ...
    Function: this function gets game location by loc ID, as given in the game_location_details dictionary
    Response: Returns all the info regarding the game location.
    """
